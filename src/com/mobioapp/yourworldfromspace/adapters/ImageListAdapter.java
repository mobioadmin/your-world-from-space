...
public class ImageListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.textView2.setText("Total Likes: "
				+ all_images.get(position).getLikes());
		//System.out.println("PHOTO:::" + all_images.get(position).getId()+ ":::" + all_images.get(position).getLikes());
		imageLoader.displayImage(all_images.get(position).getLink(),
